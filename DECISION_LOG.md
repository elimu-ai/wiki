...
| Date | Decision | Reason | Details | Owner |
| -------- | ------- | ------- | ------- | ------- |
| 2025-04 | Introduce hierarchical library dependencies. | To make version management less complicated. | [`SOFTWARE_ARCHITECTURE.md`](https://github.com/elimu-ai/wiki/blob/main/SOFTWARE_ARCHITECTURE.md#library-dependencies) | [@jo-elimu](https://github.com/jo-elimu) |
